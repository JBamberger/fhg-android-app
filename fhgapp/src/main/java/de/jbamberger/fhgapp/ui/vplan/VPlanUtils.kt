...
object VPlanUtils {
    ...
    private val GRADE_PATTERNS = arrayOf(
        "(.*5\\D*[aA].*)", "(.*5\\D*[bB].*)", "(.*5\\D*[cC].*)", "(.*5\\D*[dD].*)",
        "(.*5\\D*[eE].*)", "(.*6\\D*[aA].*)", "(.*6\\D*[bB].*)", "(.*6\\D*[cC].*)",
        "(.*6\\D*[dD].*)", "(.*6\\D*[eE].*)", "(.*7\\D*[aA].*)", "(.*7\\D*[bB].*)",
        "(.*7\\D*[cC].*)", "(.*7\\D*[dD].*)", "(.*7\\D*[eE].*)", "(.*8\\D*[aA].*)",
        "(.*8\\D*[bB].*)", "(.*8\\D*[cC].*)", "(.*8\\D*[dD].*)", "(.*8\\D*[eE].*)",
        "(.*9\\D*[aA].*)", "(.*9\\D*[bB].*)", "(.*9\\D*[cC].*)", "(.*9\\D*[dD].*)",
        "(.*9\\D*[eE].*)", "(.*10\\D*[aA].*)", "(.*10\\D*[bB].*)", "(.*10\\D*[cC].*)",
        "(.*10\\D*[dD].*)", "(.*10\\D*[eE].*)", "(.*[kK].*1.*)", "(.*[kK].*2.*)"
    )
    ...
    fun getVPlanMatcher(settings: Settings.VPlanSettings): (VPlanRow) -> Boolean = when {
        ...
        settings.courses.isEmpty() -> getGradeMatcher(settings.grades)
            ...
            getGradeMatcher(settings.grades)(it)
                    && getCourseMatcher(settings.courses)(it)
        }
    }
