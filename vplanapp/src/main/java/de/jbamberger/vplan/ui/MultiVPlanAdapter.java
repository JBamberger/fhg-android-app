...
import de.jbamberger.vplan.data.VPlanDataWrapper;
import de.jbamberger.vplan.data.VPlanElement;
...
public class MultiVPlanAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (vPlanDataWrapper.getItemAtPosition(position).type) {
            case VPlanElement.TYPE_HEADER:
                de.jbamberger.vplan.data.VPlanHeader header = (de.jbamberger.vplan.data.VPlanHeader)
